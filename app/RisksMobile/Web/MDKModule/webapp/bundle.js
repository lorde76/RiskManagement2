...
function Initialize(context) {
    ...
    let _service1 = context.executeAction('/RisksMobile/Actions/service1/Service/InitializeOnline.action');
...
/***/ "./build.definitions/RisksMobile/Rules/service1/Mitigations/Mitigations_Cancel.js":
/*!****************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Rules/service1/Mitigations/Mitigations_Cancel.js ***!
  \****************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./build.definitions/RisksMobile/Rules/service1/Mitigations/Mitigations_CreateEntity.js":
/*!**********************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Rules/service1/Mitigations/Mitigations_CreateEntity.js ***!
  \**********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function CreateEntity(clientAPI) {
    if (clientAPI.getODataProvider('/RisksMobile/Services/service1.service').isDraftEnabled('Mitigations')) {
        return clientAPI.executeAction({
            'Name': '/RisksMobile/Actions/service1/Mitigations/Mitigations_CreateEntity.action',
            'Properties': {
                'OnSuccess': ''
            }
        }).then((result) => {
        ...
        return clientAPI.executeAction('/RisksMobile/Actions/service1/Mitigations/Mitigations_CreateEntity.action');
    }
}

/***/ }),

/***/ "./build.definitions/RisksMobile/Rules/service1/Mitigations/Mitigations_CreateRisks.js":
/*!*********************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Rules/service1/Mitigations/Mitigations_CreateRisks.js ***!
  \*********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./build.definitions/RisksMobile/Rules/service1/Mitigations/Mitigations_DeleteConfirmation.js":
/*!****************************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Rules/service1/Mitigations/Mitigations_DeleteConfirmation.js ***!
  \****************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function DeleteConfirmation(clientAPI) {
    return clientAPI.executeAction('/RisksMobile/Actions/DeleteConfirmation.action').then((result) => {
        if (result.data) {
            return clientAPI.executeAction('/RisksMobile/Actions/service1/Mitigations/Mitigations_DeleteEntity.action').then(
...
/***/ "./build.definitions/RisksMobile/Rules/service1/Mitigations/Mitigations_UpdateEntity.js":
/*!**********************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Rules/service1/Mitigations/Mitigations_UpdateEntity.js ***!
  \**********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function UpdateEntity(clientAPI) {
    if (clientAPI.getODataProvider('/RisksMobile/Services/service1.service').isDraftEnabled('Mitigations')) {
        return clientAPI.executeAction({
            'Name': '/RisksMobile/Actions/service1/Mitigations/Mitigations_UpdateEntity.action',
            'Properties': {
                'OnSuccess': ''
            }
        }).then((result) => {
        ...
        return clientAPI.executeAction('/RisksMobile/Actions/service1/Mitigations/Mitigations_UpdateEntity.action');
    }
}

/***/ }),

/***/ "./build.definitions/RisksMobile/Rules/service1/Mitigations/NavToMitigations_CreateRisks.js":
/*!**************************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Rules/service1/Mitigations/NavToMitigations_CreateRisks.js ***!
  \**************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./build.definitions/RisksMobile/Rules/service1/Mitigations/NavToMitigations_Edit.js":
/*!*******************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Rules/service1/Mitigations/NavToMitigations_Edit.js ***!
  \*******************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./build.definitions/RisksMobile/Rules/service1/Risks/NavToRisks_Edit.js":
/*!*******************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Rules/service1/Risks/NavToRisks_Edit.js ***!
  \*******************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
    ...
    if (clientAPI.getODataProvider('/RisksMobile/Services/service1.service').isDraftEnabled('Risks')) {
        return clientAPI.executeAction({
            ...
            'Properties': {
                ...
                'OnSuccess': '/RisksMobile/Actions/service1/Risks/NavToRisks_Edit.action'
            }
        });
    } else {
        return clientAPI.executeAction('/RisksMobile/Actions/service1/Risks/NavToRisks_Edit.action');
    }
}

/***/ }),

/***/ "./build.definitions/RisksMobile/Rules/service1/Risks/Risks_Cancel.js":
/*!****************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Rules/service1/Risks/Risks_Cancel.js ***!
  \****************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./build.definitions/RisksMobile/Rules/service1/Risks/Risks_CreateEntity.js":
/*!**********************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Rules/service1/Risks/Risks_CreateEntity.js ***!
  \**********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function CreateEntity(clientAPI) {
    if (clientAPI.getODataProvider('/RisksMobile/Services/service1.service').isDraftEnabled('Risks')) {
        return clientAPI.executeAction({
            'Name': '/RisksMobile/Actions/service1/Risks/Risks_CreateEntity.action',
            'Properties': {
                'OnSuccess': ''
            }
        }).then((result) => {
        ...
        return clientAPI.executeAction('/RisksMobile/Actions/service1/Risks/Risks_CreateEntity.action');
    }
}

/***/ }),

/***/ "./build.definitions/RisksMobile/Rules/service1/Risks/Risks_DeleteConfirmation.js":
/*!****************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Rules/service1/Risks/Risks_DeleteConfirmation.js ***!
  \****************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function DeleteConfirmation(clientAPI) {
    return clientAPI.executeAction('/RisksMobile/Actions/DeleteConfirmation.action').then((result) => {
        if (result.data) {
            return clientAPI.executeAction('/RisksMobile/Actions/service1/Risks/Risks_DeleteEntity.action').then(
                (success) => Promise.resolve(success),
                (failure) => Promise.reject('Delete entity failed ' + failure));
        } else {
            return Promise.reject('User Deferred');
...
/***/ "./build.definitions/RisksMobile/Rules/service1/Risks/Risks_UpdateEntity.js":
/*!**********************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Rules/service1/Risks/Risks_UpdateEntity.js ***!
  \**********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
let risksmobile_actions_service1_mitigations_mitigations_createentity_action = __webpack_require__(/*! ./RisksMobile/Actions/service1/Mitigations/Mitigations_CreateEntity.action */ "./build.definitions/RisksMobile/Actions/service1/Mitigations/Mitigations_CreateEntity.action")
let risksmobile_actions_service1_mitigations_mitigations_createrisks_action = __webpack_require__(/*! ./RisksMobile/Actions/service1/Mitigations/Mitigations_CreateRisks.action */ "./build.definitions/RisksMobile/Actions/service1/Mitigations/Mitigations_CreateRisks.action")
let risksmobile_actions_service1_mitigations_mitigations_deleteentity_action = __webpack_require__(/*! ./RisksMobile/Actions/service1/Mitigations/Mitigations_DeleteEntity.action */ "./build.definitions/RisksMobile/Actions/service1/Mitigations/Mitigations_DeleteEntity.action")
let risksmobile_actions_service1_mitigations_mitigations_detailpopover_action = __webpack_require__(/*! ./RisksMobile/Actions/service1/Mitigations/Mitigations_DetailPopover.action */ "./build.definitions/RisksMobile/Actions/service1/Mitigations/Mitigations_DetailPopover.action")
let risksmobile_actions_service1_mitigations_mitigations_updateentity_action = __webpack_require__(/*! ./RisksMobile/Actions/service1/Mitigations/Mitigations_UpdateEntity.action */ "./build.definitions/RisksMobile/Actions/service1/Mitigations/Mitigations_UpdateEntity.action")
let risksmobile_actions_service1_mitigations_navtomitigations_create_action = __webpack_require__(/*! ./RisksMobile/Actions/service1/Mitigations/NavToMitigations_Create.action */ "./build.definitions/RisksMobile/Actions/service1/Mitigations/NavToMitigations_Create.action")
let risksmobile_actions_service1_mitigations_navtomitigations_createrisks_action = __webpack_require__(/*! ./RisksMobile/Actions/service1/Mitigations/NavToMitigations_CreateRisks.action */ "./build.definitions/RisksMobile/Actions/service1/Mitigations/NavToMitigations_CreateRisks.action")
let risksmobile_actions_service1_mitigations_navtomitigations_detail_action = __webpack_require__(/*! ./RisksMobile/Actions/service1/Mitigations/NavToMitigations_Detail.action */ "./build.definitions/RisksMobile/Actions/service1/Mitigations/NavToMitigations_Detail.action")
let risksmobile_actions_service1_mitigations_navtomitigations_edit_action = __webpack_require__(/*! ./RisksMobile/Actions/service1/Mitigations/NavToMitigations_Edit.action */ "./build.definitions/RisksMobile/Actions/service1/Mitigations/NavToMitigations_Edit.action")
let risksmobile_actions_service1_mitigations_navtomitigations_list_action = __webpack_require__(/*! ./RisksMobile/Actions/service1/Mitigations/NavToMitigations_List.action */ "./build.definitions/RisksMobile/Actions/service1/Mitigations/NavToMitigations_List.action")
let risksmobile_actions_service1_risks_navtorisks_create_action = __webpack_require__(/*! ./RisksMobile/Actions/service1/Risks/NavToRisks_Create.action */ "./build.definitions/RisksMobile/Actions/service1/Risks/NavToRisks_Create.action")
let risksmobile_actions_service1_risks_navtorisks_detail_action = __webpack_require__(/*! ./RisksMobile/Actions/service1/Risks/NavToRisks_Detail.action */ "./build.definitions/RisksMobile/Actions/service1/Risks/NavToRisks_Detail.action")
let risksmobile_actions_service1_risks_navtorisks_edit_action = __webpack_require__(/*! ./RisksMobile/Actions/service1/Risks/NavToRisks_Edit.action */ "./build.definitions/RisksMobile/Actions/service1/Risks/NavToRisks_Edit.action")
let risksmobile_actions_service1_risks_navtorisks_list_action = __webpack_require__(/*! ./RisksMobile/Actions/service1/Risks/NavToRisks_List.action */ "./build.definitions/RisksMobile/Actions/service1/Risks/NavToRisks_List.action")
let risksmobile_actions_service1_risks_risks_createentity_action = __webpack_require__(/*! ./RisksMobile/Actions/service1/Risks/Risks_CreateEntity.action */ "./build.definitions/RisksMobile/Actions/service1/Risks/Risks_CreateEntity.action")
let risksmobile_actions_service1_risks_risks_deleteentity_action = __webpack_require__(/*! ./RisksMobile/Actions/service1/Risks/Risks_DeleteEntity.action */ "./build.definitions/RisksMobile/Actions/service1/Risks/Risks_DeleteEntity.action")
let risksmobile_actions_service1_risks_risks_updateentity_action = __webpack_require__(/*! ./RisksMobile/Actions/service1/Risks/Risks_UpdateEntity.action */ "./build.definitions/RisksMobile/Actions/service1/Risks/Risks_UpdateEntity.action")
let risksmobile_actions_service1_service_initializeonline_action = __webpack_require__(/*! ./RisksMobile/Actions/service1/Service/InitializeOnline.action */ "./build.definitions/RisksMobile/Actions/service1/Service/InitializeOnline.action")
let risksmobile_actions_service1_service_initializeonlinefailuremessage_action = __webpack_require__(/*! ./RisksMobile/Actions/service1/Service/InitializeOnlineFailureMessage.action */ "./build.definitions/RisksMobile/Actions/service1/Service/InitializeOnlineFailureMessage.action")
...
let risksmobile_pages_service1_mitigations_mitigations_create_page = __webpack_require__(/*! ./RisksMobile/Pages/service1_Mitigations/Mitigations_Create.page */ "./build.definitions/RisksMobile/Pages/service1_Mitigations/Mitigations_Create.page")
let risksmobile_pages_service1_mitigations_mitigations_createrisks_page = __webpack_require__(/*! ./RisksMobile/Pages/service1_Mitigations/Mitigations_CreateRisks.page */ "./build.definitions/RisksMobile/Pages/service1_Mitigations/Mitigations_CreateRisks.page")
let risksmobile_pages_service1_mitigations_mitigations_detail_page = __webpack_require__(/*! ./RisksMobile/Pages/service1_Mitigations/Mitigations_Detail.page */ "./build.definitions/RisksMobile/Pages/service1_Mitigations/Mitigations_Detail.page")
let risksmobile_pages_service1_mitigations_mitigations_edit_page = __webpack_require__(/*! ./RisksMobile/Pages/service1_Mitigations/Mitigations_Edit.page */ "./build.definitions/RisksMobile/Pages/service1_Mitigations/Mitigations_Edit.page")
let risksmobile_pages_service1_mitigations_mitigations_list_page = __webpack_require__(/*! ./RisksMobile/Pages/service1_Mitigations/Mitigations_List.page */ "./build.definitions/RisksMobile/Pages/service1_Mitigations/Mitigations_List.page")
let risksmobile_pages_service1_risks_risks_create_page = __webpack_require__(/*! ./RisksMobile/Pages/service1_Risks/Risks_Create.page */ "./build.definitions/RisksMobile/Pages/service1_Risks/Risks_Create.page")
let risksmobile_pages_service1_risks_risks_detail_page = __webpack_require__(/*! ./RisksMobile/Pages/service1_Risks/Risks_Detail.page */ "./build.definitions/RisksMobile/Pages/service1_Risks/Risks_Detail.page")
let risksmobile_pages_service1_risks_risks_edit_page = __webpack_require__(/*! ./RisksMobile/Pages/service1_Risks/Risks_Edit.page */ "./build.definitions/RisksMobile/Pages/service1_Risks/Risks_Edit.page")
let risksmobile_pages_service1_risks_risks_list_page = __webpack_require__(/*! ./RisksMobile/Pages/service1_Risks/Risks_List.page */ "./build.definitions/RisksMobile/Pages/service1_Risks/Risks_List.page")
...
let risksmobile_rules_service1_mitigations_mitigations_cancel_js = __webpack_require__(/*! ./RisksMobile/Rules/service1/Mitigations/Mitigations_Cancel.js */ "./build.definitions/RisksMobile/Rules/service1/Mitigations/Mitigations_Cancel.js")
let risksmobile_rules_service1_mitigations_mitigations_createentity_js = __webpack_require__(/*! ./RisksMobile/Rules/service1/Mitigations/Mitigations_CreateEntity.js */ "./build.definitions/RisksMobile/Rules/service1/Mitigations/Mitigations_CreateEntity.js")
let risksmobile_rules_service1_mitigations_mitigations_createrisks_js = __webpack_require__(/*! ./RisksMobile/Rules/service1/Mitigations/Mitigations_CreateRisks.js */ "./build.definitions/RisksMobile/Rules/service1/Mitigations/Mitigations_CreateRisks.js")
let risksmobile_rules_service1_mitigations_mitigations_deleteconfirmation_js = __webpack_require__(/*! ./RisksMobile/Rules/service1/Mitigations/Mitigations_DeleteConfirmation.js */ "./build.definitions/RisksMobile/Rules/service1/Mitigations/Mitigations_DeleteConfirmation.js")
let risksmobile_rules_service1_mitigations_mitigations_updateentity_js = __webpack_require__(/*! ./RisksMobile/Rules/service1/Mitigations/Mitigations_UpdateEntity.js */ "./build.definitions/RisksMobile/Rules/service1/Mitigations/Mitigations_UpdateEntity.js")
let risksmobile_rules_service1_mitigations_navtomitigations_createrisks_js = __webpack_require__(/*! ./RisksMobile/Rules/service1/Mitigations/NavToMitigations_CreateRisks.js */ "./build.definitions/RisksMobile/Rules/service1/Mitigations/NavToMitigations_CreateRisks.js")
let risksmobile_rules_service1_mitigations_navtomitigations_edit_js = __webpack_require__(/*! ./RisksMobile/Rules/service1/Mitigations/NavToMitigations_Edit.js */ "./build.definitions/RisksMobile/Rules/service1/Mitigations/NavToMitigations_Edit.js")
let risksmobile_rules_service1_risks_navtorisks_edit_js = __webpack_require__(/*! ./RisksMobile/Rules/service1/Risks/NavToRisks_Edit.js */ "./build.definitions/RisksMobile/Rules/service1/Risks/NavToRisks_Edit.js")
let risksmobile_rules_service1_risks_risks_cancel_js = __webpack_require__(/*! ./RisksMobile/Rules/service1/Risks/Risks_Cancel.js */ "./build.definitions/RisksMobile/Rules/service1/Risks/Risks_Cancel.js")
let risksmobile_rules_service1_risks_risks_createentity_js = __webpack_require__(/*! ./RisksMobile/Rules/service1/Risks/Risks_CreateEntity.js */ "./build.definitions/RisksMobile/Rules/service1/Risks/Risks_CreateEntity.js")
let risksmobile_rules_service1_risks_risks_deleteconfirmation_js = __webpack_require__(/*! ./RisksMobile/Rules/service1/Risks/Risks_DeleteConfirmation.js */ "./build.definitions/RisksMobile/Rules/service1/Risks/Risks_DeleteConfirmation.js")
let risksmobile_rules_service1_risks_risks_updateentity_js = __webpack_require__(/*! ./RisksMobile/Rules/service1/Risks/Risks_UpdateEntity.js */ "./build.definitions/RisksMobile/Rules/service1/Risks/Risks_UpdateEntity.js")
...
module.exports = {
	...
	risksmobile_actions_service1_mitigations_mitigations_createentity_action : risksmobile_actions_service1_mitigations_mitigations_createentity_action,
	risksmobile_actions_service1_mitigations_mitigations_createrisks_action : risksmobile_actions_service1_mitigations_mitigations_createrisks_action,
	risksmobile_actions_service1_mitigations_mitigations_deleteentity_action : risksmobile_actions_service1_mitigations_mitigations_deleteentity_action,
	risksmobile_actions_service1_mitigations_mitigations_detailpopover_action : risksmobile_actions_service1_mitigations_mitigations_detailpopover_action,
	risksmobile_actions_service1_mitigations_mitigations_updateentity_action : risksmobile_actions_service1_mitigations_mitigations_updateentity_action,
	risksmobile_actions_service1_mitigations_navtomitigations_create_action : risksmobile_actions_service1_mitigations_navtomitigations_create_action,
	risksmobile_actions_service1_mitigations_navtomitigations_createrisks_action : risksmobile_actions_service1_mitigations_navtomitigations_createrisks_action,
	risksmobile_actions_service1_mitigations_navtomitigations_detail_action : risksmobile_actions_service1_mitigations_navtomitigations_detail_action,
	risksmobile_actions_service1_mitigations_navtomitigations_edit_action : risksmobile_actions_service1_mitigations_navtomitigations_edit_action,
	risksmobile_actions_service1_mitigations_navtomitigations_list_action : risksmobile_actions_service1_mitigations_navtomitigations_list_action,
	risksmobile_actions_service1_risks_navtorisks_create_action : risksmobile_actions_service1_risks_navtorisks_create_action,
	risksmobile_actions_service1_risks_navtorisks_detail_action : risksmobile_actions_service1_risks_navtorisks_detail_action,
	risksmobile_actions_service1_risks_navtorisks_edit_action : risksmobile_actions_service1_risks_navtorisks_edit_action,
	risksmobile_actions_service1_risks_navtorisks_list_action : risksmobile_actions_service1_risks_navtorisks_list_action,
	risksmobile_actions_service1_risks_risks_createentity_action : risksmobile_actions_service1_risks_risks_createentity_action,
	risksmobile_actions_service1_risks_risks_deleteentity_action : risksmobile_actions_service1_risks_risks_deleteentity_action,
	risksmobile_actions_service1_risks_risks_updateentity_action : risksmobile_actions_service1_risks_risks_updateentity_action,
	risksmobile_actions_service1_service_initializeonline_action : risksmobile_actions_service1_service_initializeonline_action,
	risksmobile_actions_service1_service_initializeonlinefailuremessage_action : risksmobile_actions_service1_service_initializeonlinefailuremessage_action,
	...
	risksmobile_pages_service1_mitigations_mitigations_create_page : risksmobile_pages_service1_mitigations_mitigations_create_page,
	risksmobile_pages_service1_mitigations_mitigations_createrisks_page : risksmobile_pages_service1_mitigations_mitigations_createrisks_page,
	risksmobile_pages_service1_mitigations_mitigations_detail_page : risksmobile_pages_service1_mitigations_mitigations_detail_page,
	risksmobile_pages_service1_mitigations_mitigations_edit_page : risksmobile_pages_service1_mitigations_mitigations_edit_page,
	risksmobile_pages_service1_mitigations_mitigations_list_page : risksmobile_pages_service1_mitigations_mitigations_list_page,
	risksmobile_pages_service1_risks_risks_create_page : risksmobile_pages_service1_risks_risks_create_page,
	risksmobile_pages_service1_risks_risks_detail_page : risksmobile_pages_service1_risks_risks_detail_page,
	risksmobile_pages_service1_risks_risks_edit_page : risksmobile_pages_service1_risks_risks_edit_page,
	risksmobile_pages_service1_risks_risks_list_page : risksmobile_pages_service1_risks_risks_list_page,
	...
	risksmobile_rules_service1_mitigations_mitigations_cancel_js : risksmobile_rules_service1_mitigations_mitigations_cancel_js,
	risksmobile_rules_service1_mitigations_mitigations_createentity_js : risksmobile_rules_service1_mitigations_mitigations_createentity_js,
	risksmobile_rules_service1_mitigations_mitigations_createrisks_js : risksmobile_rules_service1_mitigations_mitigations_createrisks_js,
	risksmobile_rules_service1_mitigations_mitigations_deleteconfirmation_js : risksmobile_rules_service1_mitigations_mitigations_deleteconfirmation_js,
	risksmobile_rules_service1_mitigations_mitigations_updateentity_js : risksmobile_rules_service1_mitigations_mitigations_updateentity_js,
	risksmobile_rules_service1_mitigations_navtomitigations_createrisks_js : risksmobile_rules_service1_mitigations_navtomitigations_createrisks_js,
	risksmobile_rules_service1_mitigations_navtomitigations_edit_js : risksmobile_rules_service1_mitigations_navtomitigations_edit_js,
	risksmobile_rules_service1_risks_navtorisks_edit_js : risksmobile_rules_service1_risks_navtorisks_edit_js,
	risksmobile_rules_service1_risks_risks_cancel_js : risksmobile_rules_service1_risks_risks_cancel_js,
	risksmobile_rules_service1_risks_risks_createentity_js : risksmobile_rules_service1_risks_risks_createentity_js,
	risksmobile_rules_service1_risks_risks_deleteconfirmation_js : risksmobile_rules_service1_risks_risks_deleteconfirmation_js,
	risksmobile_rules_service1_risks_risks_updateentity_js : risksmobile_rules_service1_risks_risks_updateentity_js,
...
module.exports = {"_Name":"RisksMobile","Version":"/RisksMobile/Globals/Application/AppDefinition_Version.global","MainPage":"/RisksMobile/Pages/Main.page","OnLaunch":"/RisksMobile/Rules/Service/Initialize.js","OnWillUpdate":"/RisksMobile/Rules/Application/OnWillUpdate.js","OnDidUpdate":"/RisksMobile/Rules/Service/Initialize.js","Styles":"/RisksMobile/Styles/Styles.less","Localization":"/RisksMobile/i18n/i18n.properties","_SchemaVersion":"24.4","StyleSheets":{"Styles":{"css":"/RisksMobile/Styles/Styles.css","ios":"/RisksMobile/Styles/Styles.nss","android":"/RisksMobile/Styles/Styles.json"}}}
...
/***/ "./build.definitions/RisksMobile/Actions/service1/Mitigations/Mitigations_CreateEntity.action":
/*!****************************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/service1/Mitigations/Mitigations_CreateEntity.action ***!
  \****************************************************************************************************/
/***/ ((module) => {

module.exports = {"CreateLinks":[],"OnFailure":"/RisksMobile/Actions/CreateEntityFailureMessage.action","OnSuccess":"/RisksMobile/Actions/CreateEntitySuccessMessage.action","Properties":{"createdAt":"#Control:createdAt/#Value","createdBy":"#Control:createdBy/#Value","description":"#Control:description/#Value","owner":"#Control:owner/#Value","timeline":"#Control:timeline/#Value"},"Target":{"EntitySet":"Mitigations","Service":"/RisksMobile/Services/service1.service"},"ActionResult":{"_Name":"create"},"_Type":"Action.Type.ODataService.CreateEntity"}

/***/ }),

/***/ "./build.definitions/RisksMobile/Actions/service1/Mitigations/Mitigations_CreateRisks.action":
/*!***************************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/service1/Mitigations/Mitigations_CreateRisks.action ***!
  \***************************************************************************************************/
/***/ ((module) => {

module.exports = {"ParentLink":{"Property":"risks","Target":{"EntitySet":"Mitigations","ReadLink":"{@odata.readLink}"}},"OnFailure":"/RisksMobile/Actions/CreateEntityFailureMessage.action","OnSuccess":"/RisksMobile/Actions/CreateEntitySuccessMessage.action","Properties":{"title":"#Control:title/#Value","prio":"#Control:prio/#Value","impact":"#Control:impact/#Value","criticality":"#Control:criticality/#Value"},"Target":{"EntitySet":"Risks","Service":"/RisksMobile/Services/service1.service"},"ActionResult":{"_Name":"create"},"_Type":"Action.Type.ODataService.CreateRelatedEntity"}

/***/ }),

/***/ "./build.definitions/RisksMobile/Actions/service1/Mitigations/Mitigations_DeleteEntity.action":
/*!****************************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/service1/Mitigations/Mitigations_DeleteEntity.action ***!
  \****************************************************************************************************/
/***/ ((module) => {
...
/***/ "./build.definitions/RisksMobile/Actions/service1/Mitigations/Mitigations_DetailPopover.action":
/*!*****************************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/service1/Mitigations/Mitigations_DetailPopover.action ***!
  \*****************************************************************************************************/
/***/ ((module) => {

module.exports = {"PopoverItems":[{"Title":"Add Risks","OnPress":"/RisksMobile/Rules/service1/Mitigations/NavToMitigations_CreateRisks.js"},{"Title":"Delete","OnPress":"/RisksMobile/Rules/service1/Mitigations/Mitigations_DeleteConfirmation.js"}],"_Type":"Action.Type.PopoverMenu"}

/***/ }),

/***/ "./build.definitions/RisksMobile/Actions/service1/Mitigations/Mitigations_UpdateEntity.action":
/*!****************************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/service1/Mitigations/Mitigations_UpdateEntity.action ***!
  \****************************************************************************************************/
/***/ ((module) => {

module.exports = {"_Type":"Action.Type.ODataService.UpdateEntity","Target":{"EntitySet":"Mitigations","Service":"/RisksMobile/Services/service1.service","ReadLink":"{@odata.readLink}"},"Properties":{"createdAt":"#Control:createdAt/#Value","createdBy":"#Control:createdBy/#Value","description":"#Control:description/#Value","owner":"#Control:owner/#Value","timeline":"#Control:timeline/#Value"},"UpdateLinks":[],"ActionResult":{"_Name":"update"},"OnSuccess":"/RisksMobile/Actions/UpdateEntitySuccessMessage.action","OnFailure":"/RisksMobile/Actions/UpdateEntityFailureMessage.action"}

/***/ }),

/***/ "./build.definitions/RisksMobile/Actions/service1/Mitigations/NavToMitigations_Create.action":
/*!***************************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/service1/Mitigations/NavToMitigations_Create.action ***!
  \***************************************************************************************************/
/***/ ((module) => {

module.exports = {"ModalPageFullscreen":false,"ModalPage":true,"PageToOpen":"/RisksMobile/Pages/service1_Mitigations/Mitigations_Create.page","_Type":"Action.Type.Navigation"}

/***/ }),

/***/ "./build.definitions/RisksMobile/Actions/service1/Mitigations/NavToMitigations_CreateRisks.action":
/*!********************************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/service1/Mitigations/NavToMitigations_CreateRisks.action ***!
  \********************************************************************************************************/
/***/ ((module) => {

module.exports = {"ModalPageFullscreen":false,"ModalPage":true,"PageToOpen":"/RisksMobile/Pages/service1_Mitigations/Mitigations_CreateRisks.page","_Type":"Action.Type.Navigation"}

/***/ }),

/***/ "./build.definitions/RisksMobile/Actions/service1/Mitigations/NavToMitigations_Detail.action":
/*!***************************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/service1/Mitigations/NavToMitigations_Detail.action ***!
  \***************************************************************************************************/
/***/ ((module) => {

module.exports = {"_Type":"Action.Type.Navigation","PageToOpen":"/RisksMobile/Pages/service1_Mitigations/Mitigations_Detail.page"}

/***/ }),

/***/ "./build.definitions/RisksMobile/Actions/service1/Mitigations/NavToMitigations_Edit.action":
/*!*************************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/service1/Mitigations/NavToMitigations_Edit.action ***!
  \*************************************************************************************************/
/***/ ((module) => {

module.exports = {"ModalPageFullscreen":false,"ModalPage":true,"PageToOpen":"/RisksMobile/Pages/service1_Mitigations/Mitigations_Edit.page","_Type":"Action.Type.Navigation"}

/***/ }),

/***/ "./build.definitions/RisksMobile/Actions/service1/Mitigations/NavToMitigations_List.action":
/*!*************************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/service1/Mitigations/NavToMitigations_List.action ***!
  \*************************************************************************************************/
/***/ ((module) => {

module.exports = {"_Type":"Action.Type.Navigation","PageToOpen":"/RisksMobile/Pages/service1_Mitigations/Mitigations_List.page"}

/***/ }),

/***/ "./build.definitions/RisksMobile/Actions/service1/Risks/NavToRisks_Create.action":
/*!***************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/service1/Risks/NavToRisks_Create.action ***!
  \***************************************************************************************/
/***/ ((module) => {

module.exports = {"ModalPageFullscreen":false,"ModalPage":true,"PageToOpen":"/RisksMobile/Pages/service1_Risks/Risks_Create.page","_Type":"Action.Type.Navigation"}

/***/ }),

/***/ "./build.definitions/RisksMobile/Actions/service1/Risks/NavToRisks_Detail.action":
/*!***************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/service1/Risks/NavToRisks_Detail.action ***!
  \***************************************************************************************/
/***/ ((module) => {

module.exports = {"_Type":"Action.Type.Navigation","PageToOpen":"/RisksMobile/Pages/service1_Risks/Risks_Detail.page"}

/***/ }),

/***/ "./build.definitions/RisksMobile/Actions/service1/Risks/NavToRisks_Edit.action":
/*!*************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/service1/Risks/NavToRisks_Edit.action ***!
  \*************************************************************************************/
/***/ ((module) => {

module.exports = {"ModalPageFullscreen":false,"ModalPage":true,"PageToOpen":"/RisksMobile/Pages/service1_Risks/Risks_Edit.page","_Type":"Action.Type.Navigation"}

/***/ }),

/***/ "./build.definitions/RisksMobile/Actions/service1/Risks/NavToRisks_List.action":
/*!*************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/service1/Risks/NavToRisks_List.action ***!
  \*************************************************************************************/
/***/ ((module) => {

module.exports = {"_Type":"Action.Type.Navigation","PageToOpen":"/RisksMobile/Pages/service1_Risks/Risks_List.page"}

/***/ }),

/***/ "./build.definitions/RisksMobile/Actions/service1/Risks/Risks_CreateEntity.action":
/*!****************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/service1/Risks/Risks_CreateEntity.action ***!
  \****************************************************************************************/
/***/ ((module) => {
...
/***/ "./build.definitions/RisksMobile/Actions/service1/Risks/Risks_DeleteEntity.action":
/*!****************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/service1/Risks/Risks_DeleteEntity.action ***!
  \****************************************************************************************/
/***/ ((module) => {
...
/***/ "./build.definitions/RisksMobile/Actions/service1/Risks/Risks_UpdateEntity.action":
/*!****************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/service1/Risks/Risks_UpdateEntity.action ***!
  \****************************************************************************************/
/***/ ((module) => {

module.exports = {"_Type":"Action.Type.ODataService.UpdateEntity","Target":{"EntitySet":"Risks","Service":"/RisksMobile/Services/service1.service","ReadLink":"{@odata.readLink}"},"Properties":{"title":"#Control:title/#Value","prio":"#Control:prio/#Value","impact":"#Control:impact/#Value","criticality":"#Control:criticality/#Value"},"UpdateLinks":[],"ActionResult":{"_Name":"update"},"OnSuccess":"/RisksMobile/Actions/UpdateEntitySuccessMessage.action","OnFailure":"/RisksMobile/Actions/UpdateEntityFailureMessage.action"}

/***/ }),

/***/ "./build.definitions/RisksMobile/Actions/service1/Service/InitializeOnline.action":
/*!****************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/service1/Service/InitializeOnline.action ***!
  \****************************************************************************************/
/***/ ((module) => {

module.exports = {"Service":"/RisksMobile/Services/service1.service","_Type":"Action.Type.ODataService.Initialize","ShowActivityIndicator":true,"OnFailure":"/RisksMobile/Actions/service1/Service/InitializeOnlineFailureMessage.action","ActionResult":{"_Name":"init"}}

/***/ }),

/***/ "./build.definitions/RisksMobile/Actions/service1/Service/InitializeOnlineFailureMessage.action":
/*!******************************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/service1/Service/InitializeOnlineFailureMessage.action ***!
  \******************************************************************************************************/
/***/ ((module) => {
